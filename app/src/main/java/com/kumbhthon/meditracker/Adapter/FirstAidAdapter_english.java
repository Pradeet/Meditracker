...
public class FirstAidAdapter_english extends BaseExpandableListAdapter {
    ...
    String[][] childlist = {
            {
                    ...
                    "2. Wash the wound throughly with soap & water.",
...

            {
                    ...
                    "3. Do not make incision at the wound of bite.",
...

            {
                    ...
                    "3. Do not bandage the eye.",
                    "4. Get medical help.",

                    "b. For blow to eye :-",
                    "1. Apply cold compression.",
                    "2. Do not press the eye.",
                    "3. Visit eye specialist.",

                    "c. For a foreign objects in the eye :-",
                    "1. Do not rub eyes.",
            ...
            },
            {
                    ...
                    "2. Remove dirt/debris on the wound.",
                    "3. For dressing visit hospitals.",
                    "4. Apply gentle pressure if bleeding persist."
...

            {
                    ...
                    "4. Get medical aid as soon as possible.",
