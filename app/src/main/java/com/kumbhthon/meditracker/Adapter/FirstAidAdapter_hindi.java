...
public class FirstAidAdapter_hindi extends BaseExpandableListAdapter {
    ...
    String[][] childlist = {

            {
                    ...
                    "४. आगे के इलाज के लिए अस्पताल की सहायता ले|",
...

            {
                    ...
                    "५. आगे के इलाज के लिए अस्पताल की सहायता ले|",
...

            {
                    ...
                    "४. स्प्लिंट का प्रयोग करके दंश वाले बाजु को स्थिर रखे।",
                    "५. बॅंडेज को कसकर बांधे।",

            },

            {
                    "१. काटे हुए स्थान साबुन  या पानी से धोए।",
...

            {
                    ...
                    "२.आखमे दर्द,रक्त के बहाव, सुजन के लिेए कोल्ड कर्शर्म्पेन करे।",
                    "३. आगे के इलाज के लिए अस्पताल की सहायता ले।"
            },
...

            {
                    ...
                    "३. स्पंज को पानी से भिगोकर मरिज को उससे पोछे।",
                    "४. आगे के इलाज के लिए अस्पताल की  सहायता ले।",
            },

            {
                    "१. काम न करे, आराम करे।",
                    "२. सुजन कम करने वाला जेल /दवाइया लगाए।",
                    "३. आगे के इलाज के लिए अस्पताल की सहायता ले।"
    ...
    public FirstAidAdapter_hindi(Context context) {
