			...
			if(!address.isEmpty())
			{
				...
				if(objAdrs != null)
				{
					...
					if((adrs.getAddressLine(0) != null))
						addressString += " " + adrs.getAddressLine(0).toString() + ", "; System.out.println("getAddressLine(0)-> " + adrs.getAddressLine(0).toString());
					if((adrs.getLocality() != null))
						addressString += adrs.getLocality().toString() + ", "; System.out.println("getLocality()-> " + adrs.getLocality().toString());
					if((adrs.getAdminArea() != null))
						addressString += adrs.getAdminArea() + ", ";System.out.println("getAdminArea()-> " +  adrs.getAdminArea());
					if((adrs.getCountryName() != null))
						addressString += adrs.getCountryName().toString();System.out.println("adrs.getCountryName().toString() -> " + adrs.getCountryName().toString());
